...
#FILE PATHS
#dir_path = "/Users/PK/Desktop/C-lab/projects/Neurogenetics/Candidate-gene-cognition-discovery/"
dir_path = "/Users/PK/Dropbox/gea/submissionFiles/Neuroimage/code/"
input_path = os.path.join(dir_path, "input/")
output_path = os.path.join(dir_path,"output/")

#OUTPUT FILE
output_file = (os.path.join(output_path,"xData - "+cog_function+"_"+ROI+".csv")) #full data output
...
#PREPARING GSEA-PRERANKED INPUT FILE
